...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en eksempelrapport fra pilot
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "pilot")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "pilot"))`'
...
f <- pilot::makeHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
